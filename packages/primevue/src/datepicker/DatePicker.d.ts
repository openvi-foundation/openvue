...
import type { ButtonPassThroughOptions, ButtonProps } from 'openvue/button';
...
export interface DatePickerProps {
    ...
    /**
     * Format of the date. Defaults to OpenVue Locale configuration.
     */
 ...
 *
 * [Live Demo](https://openvue.dev/calendar/)
 * --- ---
