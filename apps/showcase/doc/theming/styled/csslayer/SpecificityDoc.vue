<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>
            The <i>cssLayer</i> is disabled by default, when it is enabled at theme configuration, OpenVue wraps the built-in style classes under the <i>primevue</i> cascade layer to make the library styles easy to override. CSS in your app without
