    ...
    <DocSectionText v-bind="$attrs">
        <ul class="leading-normal px-10 mb-2 list-disc">
            <li>
                ...
                <p>
                    The Preview file is <b>view-only</b>, so it can't be published. To use the library, download the .fig file and import it into your Figma workspace. Once imported, you'll be able to open the file and publish it as a
