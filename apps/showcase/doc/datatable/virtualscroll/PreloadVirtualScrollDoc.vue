<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <OpenVueNuxtLink to="/virtualscroller">VirtualScroller</OpenVueNuxtLink> component is utilized so refer to the API of VirtualScroller for more information about the available options.
        </p>
