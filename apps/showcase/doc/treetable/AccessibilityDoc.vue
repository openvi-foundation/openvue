<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>Paginator is a standalone component used inside the DataTable, refer to the <OpenVueNuxtLink to="/paginator">paginator</OpenVueNuxtLink> for more information about the accessibility features.</p>
