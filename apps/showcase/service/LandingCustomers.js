/* Fifty customers for the landing page demo table. A trimmed copy of CustomerService so the
   homepage does not ship the full 118 KB dataset the documentation demos need. */
