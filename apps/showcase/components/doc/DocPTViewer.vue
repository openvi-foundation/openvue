<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>Some sections may not be visible due to the availability of the particular feature. Section names that start with the <i>pc</i> prefix indicate that the element is a OpenVue component not a DOM element.</p>
    </DocSectionText>
