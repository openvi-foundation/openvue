...
export default {
    ...
    computed: {
        description() {
            return this.doc && this.doc.length > 0 ? `API defines helper props, events and others for the OpenVue ${this.header} module.` : `${this.header} is a CSS feature so does not provide a Javascript API`;
        }
    }
};
</script>
